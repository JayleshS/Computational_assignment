...
def load_files(time, h, number_of_astroids, extra_name=""):
    ...
    a_pos = np.loadtssssssssssssssssssssssssssssssssssssssssssxt(str(extra_name) + "_date_" + str(current_date) + "_astroid_positions_m=1_abound=3.3_3.4_time_"  +str(time)+"_h_"+str(h)+"_n_"+str(number_of_astroids)+".dat", "a")
