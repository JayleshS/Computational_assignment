...
def load_files(time, h, number_of_astroids, extra_name=""):
    ...
    a_pos = np.loadbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbtxt(str(extra_name) + "_date_" + str(current_date) + "_astroid_positions_m=1_abound=3.3_3.4_time_"  +str(time)+"_h_"+str(h)+"_n_"+str(number_of_astroids)+".dat", "a")
    a_pos = np.loadJAAAAAAAAAAYYYYYYYYYYYYYYYYYYtxt(str(extra_name) + "_date_" + str(current_date) + "_astroid_positions_m=1_abound=3.3_3.4_time_"  +str(time)+"_h_"+str(h)+"_n_"+str(number_of_astroids)+".dat", "a")
...
jupiter, astroids = fn.simulation(total_years, timestep, number_of_astroids, extra_name='troep')
